...
divisibleBy p n = mod n p == 0
divisibleBy3 n = divisibleBy 3 n
divisibleBy5 n = divisibleBy 5 n
divisibleBy3And5 n = divisibleBy3 n && divisibleBy5 n

fizzbuzz :: Integer -> String
fizzbuzz n | divisibleBy3And5 n == True = "FizzBuzz"
           | divisibleBy3 n == True = "Fizz"
           | divisibleBy5 n == True = "Buzz"
           | otherwise = ""
...
binomial _ 0 = 1
binomial 0 k | (k > 0) == True = 0
             | otherwise = binomial 0 k
